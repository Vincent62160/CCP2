...
class ViewCategorieController extends AbstractController
{
     ...
     */
    public function index(int $id,ArticleRepository $articleRepository,ImagesRepository $imagesRepository,CategorieRepository $categorieRepository, GenreRepository $genreRepository,CgvcguRepository $cgvcguRepository): Response
    {
