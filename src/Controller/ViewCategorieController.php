...
class ViewCategorieController extends AbstractController
{
     ...
     */
    public function index(int $id,EnteteRepository $enteteRepository,ArticleRepository $articleRepository,ImagesRepository $imagesRepository,CategorieRepository $categorieRepository, GenreRepository $genreRepository,CgvcguRepository $cgvcguRepository): Response
    {
